...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  //+--------+--------+--------+--------+--------+--------+                          +--------+--------+--------+--------+--------+--------+
     KC_TAB,  _______, C(KC_C), KC_END,  KC_F5,   _______,                            C(KC_V), _______, KC_TAB,  _______, KC_UP,   JP_PIPE,
  //+--------+--------+--------+--------+--------+--------+                          +--------+--------+--------+--------+--------+--------+
     KC_LCMD, KC_HOME, C(KC_F), KC_DEL,  KC_RGHT, _______,                            KC_BSPC, _______, _______, JP_LBRC, JP_RBRC, JP_YEN,
  //+--------+--------+--------+--------+--------+--------+--------+        +--------+--------+--------+--------+--------+--------+--------+
     KC_LSFT, C(KC_Z), C(KC_X), _______, _______, KC_LEFT, _______,          _______, KC_DOWN, KC_ENT,  _______, JP_LCBR, JP_RCBR, JP_BSLS,
  //+--------+--------+--------+--------+--------+--------+        +        +        +--------+--------+--------+--------+--------+--------+
  ...
  //+--------+--------+--------+--------+--------+--------+                          +--------+--------+--------+--------+--------+--------+
     _______, _______, _______, _______, _______, _______,                            BL_TOGG, BL_DEC,  BL_INC,   _______, _______, _______,
  //+--------+--------+--------+--------+--------+--------+                          +--------+--------+--------+--------+--------+--------+
